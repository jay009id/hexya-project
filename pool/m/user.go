...
type UserSet interface {
	...
	// record in this RecordSet. It returns the Go zero value if the RecordSet is empty.
	AttendedSessions() OpenAcademySessionSet
	...
	SetAttendedSessions(value OpenAcademySessionSet)
...
type UserData interface {
	...
	CreateAttendedSessions(related OpenAcademySessionData) UserData
