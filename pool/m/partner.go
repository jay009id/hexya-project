...
type PartnerData interface {
	...
	// It returns this PartnerData so that calls can be chained.
	SetAttendedSessions(value OpenAcademySessionSet) PartnerData
	// UnsetAttendedSessions removes the value of the AttendedSessions field if it exists.
	// It returns this PartnerData so that calls can be chained.
	UnsetAttendedSessions() PartnerData
	...
	CreateAttendedSessions(related OpenAcademySessionData) PartnerData
