...
// of the OpenAcademyCourse model.
...
// Responsible returns a pointer to the Responsible Field.
func (c FieldsCollection) Responsible() *models.Field {
	return c.MustGet("Responsible")
}

// Sessions returns a pointer to the Sessions Field.
func (c FieldsCollection) Sessions() *models.Field {
	return c.MustGet("Sessions")
}
...
// pActionArchive holds the metadata of the OpenAcademyCourse.ActionArchive() method
type pActionArchive struct {
	*models.Method
}

// Extend adds the given fnct function as a new layer on this method.
func (m pActionArchive) Extend(fnct func(m.OpenAcademyCourseSet)) pActionArchive {
...
// pActionUnarchive holds the metadata of the OpenAcademyCourse.ActionUnarchive() method
type pActionUnarchive struct {
	*models.Method
}

// Extend adds the given fnct function as a new layer on this method.
func (m pActionUnarchive) Extend(fnct func(m.OpenAcademyCourseSet)) pActionUnarchive {
...
// pAddDomainLimitOffset holds the metadata of the OpenAcademyCourse.AddDomainLimitOffset() method
type pAddDomainLimitOffset struct {
	*models.Method
}

// Extend adds the given fnct function as a new layer on this method.
func (m pAddDomainLimitOffset) Extend(fnct func(m.OpenAcademyCourseSet, domains.Domain, int, int, string) m.OpenAcademyCourseSet) pAddDomainLimitOffset {
...
// pAddModifiers holds the metadata of the OpenAcademyCourse.AddModifiers() method
type pAddModifiers struct {
	*models.Method
}

// Extend adds the given fnct function as a new layer on this method.
func (m pAddModifiers) Extend(fnct func(m.OpenAcademyCourseSet, *etree.Document, map[string]*models.FieldInfo)) pAddModifiers {
...
// pAddNamesToRelations holds the metadata of the OpenAcademyCourse.AddNamesToRelations() method
type pAddNamesToRelations struct {
	*models.Method
}

// Extend adds the given fnct function as a new layer on this method.
func (m pAddNamesToRelations) Extend(fnct func(m.OpenAcademyCourseSet, models.RecordData, map[string]*models.FieldInfo) models.RecordData) pAddNamesToRelations {
...
// pAggregates holds the metadata of the OpenAcademyCourse.Aggregates() method
type pAggregates struct {
	*models.Method
}

// Extend adds the given fnct function as a new layer on this method.
func (m pAggregates) Extend(fnct func(m.OpenAcademyCourseSet, ...models.FieldName) []m.OpenAcademyCourseGroupAggregateRow) pAggregates {
	return pAggregates{
		Method: m.Method.Extend(fnct),
	}
}
...
// pBrowse holds the metadata of the OpenAcademyCourse.Browse() method
type pBrowse struct {
	*models.Method
}

// Extend adds the given fnct function as a new layer on this method.
func (m pBrowse) Extend(fnct func(m.OpenAcademyCourseSet, []int64) m.OpenAcademyCourseSet) pBrowse {
	return pBrowse{
		Method: m.Method.Extend(fnct),
	}
}
...
// pBrowseOne holds the metadata of the OpenAcademyCourse.BrowseOne() method
type pBrowseOne struct {
	*models.Method
}

// Extend adds the given fnct function as a new layer on this method.
func (m pBrowseOne) Extend(fnct func(m.OpenAcademyCourseSet, int64) m.OpenAcademyCourseSet) pBrowseOne {
	return pBrowseOne{
		Method: m.Method.Extend(fnct),
	}
}
...
// pCartesianProduct holds the metadata of the OpenAcademyCourse.CartesianProduct() method
type pCartesianProduct struct {
	*models.Method
}

// Extend adds the given fnct function as a new layer on this method.
func (m pCartesianProduct) Extend(fnct func(m.OpenAcademyCourseSet, ...m.OpenAcademyCourseSet) []m.OpenAcademyCourseSet) pCartesianProduct {
...
// pCheckAccessRights holds the metadata of the OpenAcademyCourse.CheckAccessRights() method
type pCheckAccessRights struct {
	*models.Method
}

// Extend adds the given fnct function as a new layer on this method.
func (m pCheckAccessRights) Extend(fnct func(m.OpenAcademyCourseSet, webtypes.CheckAccessRightsArgs) bool) pCheckAccessRights {
...
// pCheckExecutionPermission holds the metadata of the OpenAcademyCourse.CheckExecutionPermission() method
type pCheckExecutionPermission struct {
	*models.Method
}

// Extend adds the given fnct function as a new layer on this method.
func (m pCheckExecutionPermission) Extend(fnct func(m.OpenAcademyCourseSet, *models.Method, ...bool) bool) pCheckExecutionPermission {
...
// pCheckRecursion holds the metadata of the OpenAcademyCourse.CheckRecursion() method
type pCheckRecursion struct {
	*models.Method
}

// Extend adds the given fnct function as a new layer on this method.
func (m pCheckRecursion) Extend(fnct func(m.OpenAcademyCourseSet) bool) pCheckRecursion {
...
// pComputeDisplayName holds the metadata of the OpenAcademyCourse.ComputeDisplayName() method
type pComputeDisplayName struct {
	*models.Method
}

// Extend adds the given fnct function as a new layer on this method.
func (m pComputeDisplayName) Extend(fnct func(m.OpenAcademyCourseSet) *models.ModelData) pComputeDisplayName {
...
// pComputeLastUpdate holds the metadata of the OpenAcademyCourse.ComputeLastUpdate() method
type pComputeLastUpdate struct {
	*models.Method
}

// Extend adds the given fnct function as a new layer on this method.
func (m pComputeLastUpdate) Extend(fnct func(m.OpenAcademyCourseSet) *models.ModelData) pComputeLastUpdate {
...
// pCopy holds the metadata of the OpenAcademyCourse.Copy() method
type pCopy struct {
	*models.Method
}

// Extend adds the given fnct function as a new layer on this method.
func (m pCopy) Extend(fnct func(m.OpenAcademyCourseSet, m.OpenAcademyCourseData) m.OpenAcademyCourseSet) pCopy {
	return pCopy{
		Method: m.Method.Extend(fnct),
	}
}
...
// pCopyData holds the metadata of the OpenAcademyCourse.CopyData() method
type pCopyData struct {
	*models.Method
}

// Extend adds the given fnct function as a new layer on this method.
func (m pCopyData) Extend(fnct func(m.OpenAcademyCourseSet, m.OpenAcademyCourseData) m.OpenAcademyCourseData) pCopyData {
	return pCopyData{
		Method: m.Method.Extend(fnct),
	}
}
...
// pCreate holds the metadata of the OpenAcademyCourse.Create() method
type pCreate struct {
	*models.Method
}

// Extend adds the given fnct function as a new layer on this method.
func (m pCreate) Extend(fnct func(m.OpenAcademyCourseSet, m.OpenAcademyCourseData) m.OpenAcademyCourseSet) pCreate {
	return pCreate{
		Method: m.Method.Extend(fnct),
	}
}
...
// pDefaultGet holds the metadata of the OpenAcademyCourse.DefaultGet() method
type pDefaultGet struct {
	*models.Method
}

// Extend adds the given fnct function as a new layer on this method.
func (m pDefaultGet) Extend(fnct func(m.OpenAcademyCourseSet) m.OpenAcademyCourseData) pDefaultGet {
	return pDefaultGet{
		Method: m.Method.Extend(fnct),
	}
}
...
// pEnqueue holds the metadata of the OpenAcademyCourse.Enqueue() method
type pEnqueue struct {
	*models.Method
}

// Extend adds the given fnct function as a new layer on this method.
func (m pEnqueue) Extend(fnct func(m.OpenAcademyCourseSet, string, models.Methoder, ...interface{}) m.QueueJobSet) pEnqueue {
	return pEnqueue{
		Method: m.Method.Extend(fnct),
	}
}
...
// pEquals holds the metadata of the OpenAcademyCourse.Equals() method
type pEquals struct {
	*models.Method
}

// Extend adds the given fnct function as a new layer on this method.
func (m pEquals) Extend(fnct func(m.OpenAcademyCourseSet, m.OpenAcademyCourseSet) bool) pEquals {
	return pEquals{
		Method: m.Method.Extend(fnct),
	}
}
...
// pExecuteO2MActions holds the metadata of the OpenAcademyCourse.ExecuteO2MActions() method
type pExecuteO2MActions struct {
	*models.Method
}

// Extend adds the given fnct function as a new layer on this method.
func (m pExecuteO2MActions) Extend(fnct func(m.OpenAcademyCourseSet, models.FieldName, *models.FieldInfo, interface{}) interface{}) pExecuteO2MActions {
...
// pFetch holds the metadata of the OpenAcademyCourse.Fetch() method
type pFetch struct {
	*models.Method
}

// Extend adds the given fnct function as a new layer on this method.
func (m pFetch) Extend(fnct func(m.OpenAcademyCourseSet) m.OpenAcademyCourseSet) pFetch {
	return pFetch{
		Method: m.Method.Extend(fnct),
	}
}
...
// pFieldGet holds the metadata of the OpenAcademyCourse.FieldGet() method
type pFieldGet struct {
	*models.Method
}

// Extend adds the given fnct function as a new layer on this method.
func (m pFieldGet) Extend(fnct func(m.OpenAcademyCourseSet, models.FieldName) *models.FieldInfo) pFieldGet {
	return pFieldGet{
		Method: m.Method.Extend(fnct),
	}
}
...
// pFieldsGet holds the metadata of the OpenAcademyCourse.FieldsGet() method
type pFieldsGet struct {
	*models.Method
}

// Extend adds the given fnct function as a new layer on this method.
func (m pFieldsGet) Extend(fnct func(m.OpenAcademyCourseSet, models.FieldsGetArgs) map[string]*models.FieldInfo) pFieldsGet {
	return pFieldsGet{
		Method: m.Method.Extend(fnct),
	}
}
...
// pFieldsViewGet holds the metadata of the OpenAcademyCourse.FieldsViewGet() method
type pFieldsViewGet struct {
	*models.Method
}

// Extend adds the given fnct function as a new layer on this method.
func (m pFieldsViewGet) Extend(fnct func(m.OpenAcademyCourseSet, webtypes.FieldsViewGetParams) *webtypes.FieldsViewData) pFieldsViewGet {
...
// pFiltered holds the metadata of the OpenAcademyCourse.Filtered() method
type pFiltered struct {
	*models.Method
}

// Extend adds the given fnct function as a new layer on this method.
func (m pFiltered) Extend(fnct func(m.OpenAcademyCourseSet, func(m.OpenAcademyCourseSet) bool) m.OpenAcademyCourseSet) pFiltered {
	return pFiltered{
		Method: m.Method.Extend(fnct),
	}
}
...
// pFormatRelationFields holds the metadata of the OpenAcademyCourse.FormatRelationFields() method
type pFormatRelationFields struct {
	*models.Method
}

// Extend adds the given fnct function as a new layer on this method.
func (m pFormatRelationFields) Extend(fnct func(m.OpenAcademyCourseSet, models.RecordData, map[string]*models.FieldInfo) models.RecordData) pFormatRelationFields {
...
// pGetFormviewAction holds the metadata of the OpenAcademyCourse.GetFormviewAction() method
type pGetFormviewAction struct {
	*models.Method
}

// Extend adds the given fnct function as a new layer on this method.
func (m pGetFormviewAction) Extend(fnct func(m.OpenAcademyCourseSet) *actions.Action) pGetFormviewAction {
...
// pGetFormviewId holds the metadata of the OpenAcademyCourse.GetFormviewId() method
type pGetFormviewId struct {
	*models.Method
}

// Extend adds the given fnct function as a new layer on this method.
func (m pGetFormviewId) Extend(fnct func(m.OpenAcademyCourseSet) string) pGetFormviewId {
...
// pGetRecord holds the metadata of the OpenAcademyCourse.GetRecord() method
type pGetRecord struct {
	*models.Method
}

// Extend adds the given fnct function as a new layer on this method.
func (m pGetRecord) Extend(fnct func(m.OpenAcademyCourseSet, string) m.OpenAcademyCourseSet) pGetRecord {
	return pGetRecord{
		Method: m.Method.Extend(fnct),
	}
}
...
// pGetToolbar holds the metadata of the OpenAcademyCourse.GetToolbar() method
type pGetToolbar struct {
	*models.Method
}

// Extend adds the given fnct function as a new layer on this method.
func (m pGetToolbar) Extend(fnct func(m.OpenAcademyCourseSet) webtypes.Toolbar) pGetToolbar {
	return pGetToolbar{
		Method: m.Method.Extend(fnct),
	}
}
...
// pGroupBy holds the metadata of the OpenAcademyCourse.GroupBy() method
type pGroupBy struct {
	*models.Method
}

// Extend adds the given fnct function as a new layer on this method.
func (m pGroupBy) Extend(fnct func(m.OpenAcademyCourseSet, ...models.FieldName) m.OpenAcademyCourseSet) pGroupBy {
	return pGroupBy{
		Method: m.Method.Extend(fnct),
	}
}
...
// pIntersect holds the metadata of the OpenAcademyCourse.Intersect() method
type pIntersect struct {
	*models.Method
}

// Extend adds the given fnct function as a new layer on this method.
func (m pIntersect) Extend(fnct func(m.OpenAcademyCourseSet, m.OpenAcademyCourseSet) m.OpenAcademyCourseSet) pIntersect {
	return pIntersect{
		Method: m.Method.Extend(fnct),
	}
}
...
// pLimit holds the metadata of the OpenAcademyCourse.Limit() method
type pLimit struct {
	*models.Method
}

// Extend adds the given fnct function as a new layer on this method.
func (m pLimit) Extend(fnct func(m.OpenAcademyCourseSet, int) m.OpenAcademyCourseSet) pLimit {
	return pLimit{
		Method: m.Method.Extend(fnct),
	}
}
...
// pLoad holds the metadata of the OpenAcademyCourse.Load() method
type pLoad struct {
	*models.Method
}

// Extend adds the given fnct function as a new layer on this method.
func (m pLoad) Extend(fnct func(m.OpenAcademyCourseSet, ...models.FieldName) m.OpenAcademyCourseSet) pLoad {
	return pLoad{
		Method: m.Method.Extend(fnct),
	}
}
...
// pLoadViews holds the metadata of the OpenAcademyCourse.LoadViews() method
type pLoadViews struct {
	*models.Method
}

// Extend adds the given fnct function as a new layer on this method.
func (m pLoadViews) Extend(fnct func(m.OpenAcademyCourseSet, webtypes.LoadViewsArgs) *webtypes.LoadViewsData) pLoadViews {
	return pLoadViews{
		Method: m.Method.Extend(fnct),
	}
}
...
// pManageGroupsOnFields holds the metadata of the OpenAcademyCourse.ManageGroupsOnFields() method
type pManageGroupsOnFields struct {
	*models.Method
}

// Extend adds the given fnct function as a new layer on this method.
func (m pManageGroupsOnFields) Extend(fnct func(m.OpenAcademyCourseSet, *etree.Document, map[string]*models.FieldInfo)) pManageGroupsOnFields {
...
// pNameGet holds the metadata of the OpenAcademyCourse.NameGet() method
type pNameGet struct {
	*models.Method
}

// Extend adds the given fnct function as a new layer on this method.
func (m pNameGet) Extend(fnct func(m.OpenAcademyCourseSet) string) pNameGet {
	return pNameGet{
		Method: m.Method.Extend(fnct),
	}
}
...
// pNameSearch holds the metadata of the OpenAcademyCourse.NameSearch() method
type pNameSearch struct {
	*models.Method
}

// Extend adds the given fnct function as a new layer on this method.
func (m pNameSearch) Extend(fnct func(m.OpenAcademyCourseSet, webtypes.NameSearchParams) []webtypes.RecordIDWithName) pNameSearch {
	return pNameSearch{
		Method: m.Method.Extend(fnct),
	}
}
...
// pNew holds the metadata of the OpenAcademyCourse.New() method
type pNew struct {
	*models.Method
}

// Extend adds the given fnct function as a new layer on this method.
func (m pNew) Extend(fnct func(m.OpenAcademyCourseSet, m.OpenAcademyCourseData) m.OpenAcademyCourseSet) pNew {
	return pNew{
		Method: m.Method.Extend(fnct),
	}
}
...
// pNormalizeM2MData holds the metadata of the OpenAcademyCourse.NormalizeM2MData() method
type pNormalizeM2MData struct {
	*models.Method
}

// Extend adds the given fnct function as a new layer on this method.
func (m pNormalizeM2MData) Extend(fnct func(m.OpenAcademyCourseSet, models.FieldName, *models.FieldInfo, interface{}) interface{}) pNormalizeM2MData {
...
// pOffset holds the metadata of the OpenAcademyCourse.Offset() method
type pOffset struct {
	*models.Method
}

// Extend adds the given fnct function as a new layer on this method.
func (m pOffset) Extend(fnct func(m.OpenAcademyCourseSet, int) m.OpenAcademyCourseSet) pOffset {
	return pOffset{
		Method: m.Method.Extend(fnct),
	}
}
...
// pOnchange holds the metadata of the OpenAcademyCourse.Onchange() method
type pOnchange struct {
	*models.Method
}

// Extend adds the given fnct function as a new layer on this method.
func (m pOnchange) Extend(fnct func(m.OpenAcademyCourseSet, models.OnchangeParams) models.OnchangeResult) pOnchange {
	return pOnchange{
		Method: m.Method.Extend(fnct),
	}
}
...
// pOrderBy holds the metadata of the OpenAcademyCourse.OrderBy() method
type pOrderBy struct {
	*models.Method
}

// Extend adds the given fnct function as a new layer on this method.
func (m pOrderBy) Extend(fnct func(m.OpenAcademyCourseSet, ...string) m.OpenAcademyCourseSet) pOrderBy {
	return pOrderBy{
		Method: m.Method.Extend(fnct),
	}
}
...
// pPostProcessCreateValues holds the metadata of the OpenAcademyCourse.PostProcessCreateValues() method
type pPostProcessCreateValues struct {
	*models.Method
}

// Extend adds the given fnct function as a new layer on this method.
func (m pPostProcessCreateValues) Extend(fnct func(m.OpenAcademyCourseSet, models.RecordData)) pPostProcessCreateValues {
...
// pPostProcessFilters holds the metadata of the OpenAcademyCourse.PostProcessFilters() method
type pPostProcessFilters struct {
	*models.Method
}

// Extend adds the given fnct function as a new layer on this method.
func (m pPostProcessFilters) Extend(fnct func(m.OpenAcademyCourseSet, map[models.FieldName]models.Conditioner) map[string][]interface{}) pPostProcessFilters {
...
// pProcessCreateValues holds the metadata of the OpenAcademyCourse.ProcessCreateValues() method
type pProcessCreateValues struct {
	*models.Method
}

// Extend adds the given fnct function as a new layer on this method.
func (m pProcessCreateValues) Extend(fnct func(m.OpenAcademyCourseSet, models.RecordData) (models.RecordData, models.RecordData)) pProcessCreateValues {
...
// pProcessElementAttrs holds the metadata of the OpenAcademyCourse.ProcessElementAttrs() method
type pProcessElementAttrs struct {
	*models.Method
}

// Extend adds the given fnct function as a new layer on this method.
func (m pProcessElementAttrs) Extend(fnct func(m.OpenAcademyCourseSet, *etree.Element, map[string]*models.FieldInfo) map[string]interface{}) pProcessElementAttrs {
...
// pProcessFieldElementModifiers holds the metadata of the OpenAcademyCourse.ProcessFieldElementModifiers() method
type pProcessFieldElementModifiers struct {
	*models.Method
}

// Extend adds the given fnct function as a new layer on this method.
func (m pProcessFieldElementModifiers) Extend(fnct func(m.OpenAcademyCourseSet, *etree.Element, map[string]*models.FieldInfo, map[string]interface{}) map[string]interface{}) pProcessFieldElementModifiers {
...
// pProcessView holds the metadata of the OpenAcademyCourse.ProcessView() method
type pProcessView struct {
	*models.Method
}

// Extend adds the given fnct function as a new layer on this method.
func (m pProcessView) Extend(fnct func(m.OpenAcademyCourseSet, *etree.Document, map[string]*models.FieldInfo) string) pProcessView {
	return pProcessView{
		Method: m.Method.Extend(fnct),
	}
}
...
// pProcessWriteValues holds the metadata of the OpenAcademyCourse.ProcessWriteValues() method
type pProcessWriteValues struct {
	*models.Method
}

// Extend adds the given fnct function as a new layer on this method.
func (m pProcessWriteValues) Extend(fnct func(m.OpenAcademyCourseSet, models.RecordData) models.RecordData) pProcessWriteValues {
...
// pRead holds the metadata of the OpenAcademyCourse.Read() method
type pRead struct {
	*models.Method
}

// Extend adds the given fnct function as a new layer on this method.
func (m pRead) Extend(fnct func(m.OpenAcademyCourseSet, models.FieldNames) []models.RecordData) pRead {
	return pRead{
		Method: m.Method.Extend(fnct),
	}
}
...
// pReadGroup holds the metadata of the OpenAcademyCourse.ReadGroup() method
type pReadGroup struct {
	*models.Method
}

// Extend adds the given fnct function as a new layer on this method.
func (m pReadGroup) Extend(fnct func(m.OpenAcademyCourseSet, webtypes.ReadGroupParams) []models.FieldMap) pReadGroup {
	return pReadGroup{
		Method: m.Method.Extend(fnct),
	}
}
...
// pSQLFromCondition holds the metadata of the OpenAcademyCourse.SQLFromCondition() method
type pSQLFromCondition struct {
	*models.Method
}

// Extend adds the given fnct function as a new layer on this method.
func (m pSQLFromCondition) Extend(fnct func(m.OpenAcademyCourseSet, *models.Condition) (string, models.SQLParams)) pSQLFromCondition {
...
// pSearch holds the metadata of the OpenAcademyCourse.Search() method
type pSearch struct {
	*models.Method
}

// Extend adds the given fnct function as a new layer on this method.
func (m pSearch) Extend(fnct func(m.OpenAcademyCourseSet, q.OpenAcademyCourseCondition) m.OpenAcademyCourseSet) pSearch {
	return pSearch{
		Method: m.Method.Extend(fnct),
	}
}
...
// pSearchAll holds the metadata of the OpenAcademyCourse.SearchAll() method
type pSearchAll struct {
	*models.Method
}

// Extend adds the given fnct function as a new layer on this method.
func (m pSearchAll) Extend(fnct func(m.OpenAcademyCourseSet) m.OpenAcademyCourseSet) pSearchAll {
	return pSearchAll{
		Method: m.Method.Extend(fnct),
	}
}
...
// pSearchByName holds the metadata of the OpenAcademyCourse.SearchByName() method
type pSearchByName struct {
	*models.Method
}

// Extend adds the given fnct function as a new layer on this method.
func (m pSearchByName) Extend(fnct func(m.OpenAcademyCourseSet, string, operator.Operator, q.OpenAcademyCourseCondition, int) m.OpenAcademyCourseSet) pSearchByName {
...
// pSearchCount holds the metadata of the OpenAcademyCourse.SearchCount() method
type pSearchCount struct {
	*models.Method
}

// Extend adds the given fnct function as a new layer on this method.
func (m pSearchCount) Extend(fnct func(m.OpenAcademyCourseSet) int) pSearchCount {
	return pSearchCount{
		Method: m.Method.Extend(fnct),
	}
}
...
// pSearchDomain holds the metadata of the OpenAcademyCourse.SearchDomain() method
type pSearchDomain struct {
	*models.Method
}

// Extend adds the given fnct function as a new layer on this method.
func (m pSearchDomain) Extend(fnct func(m.OpenAcademyCourseSet, domains.Domain) m.CommonMixinSet) pSearchDomain {
...
// pSearchRead holds the metadata of the OpenAcademyCourse.SearchRead() method
type pSearchRead struct {
	*models.Method
}

// Extend adds the given fnct function as a new layer on this method.
func (m pSearchRead) Extend(fnct func(m.OpenAcademyCourseSet, webtypes.SearchParams) []models.RecordData) pSearchRead {
	return pSearchRead{
		Method: m.Method.Extend(fnct),
	}
}
...
// pSorted holds the metadata of the OpenAcademyCourse.Sorted() method
type pSorted struct {
	*models.Method
}

// Extend adds the given fnct function as a new layer on this method.
func (m pSorted) Extend(fnct func(m.OpenAcademyCourseSet, func(m.OpenAcademyCourseSet, m.OpenAcademyCourseSet) bool) m.OpenAcademyCourseSet) pSorted {
	return pSorted{
		Method: m.Method.Extend(fnct),
	}
}
...
// pSortedByField holds the metadata of the OpenAcademyCourse.SortedByField() method
type pSortedByField struct {
	*models.Method
}

// Extend adds the given fnct function as a new layer on this method.
func (m pSortedByField) Extend(fnct func(m.OpenAcademyCourseSet, models.FieldName, bool) m.OpenAcademyCourseSet) pSortedByField {
...
// pSortedDefault holds the metadata of the OpenAcademyCourse.SortedDefault() method
type pSortedDefault struct {
	*models.Method
}

// Extend adds the given fnct function as a new layer on this method.
func (m pSortedDefault) Extend(fnct func(m.OpenAcademyCourseSet) m.OpenAcademyCourseSet) pSortedDefault {
...
// pSubtract holds the metadata of the OpenAcademyCourse.Subtract() method
type pSubtract struct {
	*models.Method
}

// Extend adds the given fnct function as a new layer on this method.
func (m pSubtract) Extend(fnct func(m.OpenAcademyCourseSet, m.OpenAcademyCourseSet) m.OpenAcademyCourseSet) pSubtract {
	return pSubtract{
		Method: m.Method.Extend(fnct),
	}
}
...
// pSudo holds the metadata of the OpenAcademyCourse.Sudo() method
type pSudo struct {
	*models.Method
}

// Extend adds the given fnct function as a new layer on this method.
func (m pSudo) Extend(fnct func(m.OpenAcademyCourseSet, ...int64) m.OpenAcademyCourseSet) pSudo {
	return pSudo{
		Method: m.Method.Extend(fnct),
	}
}
...
// pToggleActive holds the metadata of the OpenAcademyCourse.ToggleActive() method
type pToggleActive struct {
	*models.Method
}

// Extend adds the given fnct function as a new layer on this method.
func (m pToggleActive) Extend(fnct func(m.OpenAcademyCourseSet)) pToggleActive {
...
// pUnion holds the metadata of the OpenAcademyCourse.Union() method
type pUnion struct {
	*models.Method
}

// Extend adds the given fnct function as a new layer on this method.
func (m pUnion) Extend(fnct func(m.OpenAcademyCourseSet, m.OpenAcademyCourseSet) m.OpenAcademyCourseSet) pUnion {
	return pUnion{
		Method: m.Method.Extend(fnct),
	}
}
...
// pUnlink holds the metadata of the OpenAcademyCourse.Unlink() method
type pUnlink struct {
	*models.Method
}

// Extend adds the given fnct function as a new layer on this method.
func (m pUnlink) Extend(fnct func(m.OpenAcademyCourseSet) int64) pUnlink {
	return pUnlink{
		Method: m.Method.Extend(fnct),
	}
}
...
// pWebReadGroup holds the metadata of the OpenAcademyCourse.WebReadGroup() method
type pWebReadGroup struct {
	*models.Method
}

// Extend adds the given fnct function as a new layer on this method.
func (m pWebReadGroup) Extend(fnct func(m.OpenAcademyCourseSet, webtypes.WebReadGroupParams) webtypes.WebReadGroupResult) pWebReadGroup {
...
// pWebReadGroupPrivate holds the metadata of the OpenAcademyCourse.WebReadGroupPrivate() method
type pWebReadGroupPrivate struct {
	*models.Method
}

// Extend adds the given fnct function as a new layer on this method.
func (m pWebReadGroupPrivate) Extend(fnct func(m.OpenAcademyCourseSet, webtypes.WebReadGroupParams) []models.FieldMap) pWebReadGroupPrivate {
...
// pWebSearchRead holds the metadata of the OpenAcademyCourse.WebSearchRead() method
type pWebSearchRead struct {
	*models.Method
}

// Extend adds the given fnct function as a new layer on this method.
func (m pWebSearchRead) Extend(fnct func(m.OpenAcademyCourseSet, webtypes.SearchParams) webtypes.SearchReadResult) pWebSearchRead {
...
// pWithContext holds the metadata of the OpenAcademyCourse.WithContext() method
type pWithContext struct {
	*models.Method
}

// Extend adds the given fnct function as a new layer on this method.
func (m pWithContext) Extend(fnct func(m.OpenAcademyCourseSet, string, interface{}) m.OpenAcademyCourseSet) pWithContext {
	return pWithContext{
		Method: m.Method.Extend(fnct),
	}
}
...
// pWithEnv holds the metadata of the OpenAcademyCourse.WithEnv() method
type pWithEnv struct {
	*models.Method
}

// Extend adds the given fnct function as a new layer on this method.
func (m pWithEnv) Extend(fnct func(m.OpenAcademyCourseSet, models.Environment) m.OpenAcademyCourseSet) pWithEnv {
	return pWithEnv{
		Method: m.Method.Extend(fnct),
	}
}
...
// pWithNewContext holds the metadata of the OpenAcademyCourse.WithNewContext() method
type pWithNewContext struct {
	*models.Method
}

// Extend adds the given fnct function as a new layer on this method.
func (m pWithNewContext) Extend(fnct func(m.OpenAcademyCourseSet, *types.Context) m.OpenAcademyCourseSet) pWithNewContext {
...
// pWrite holds the metadata of the OpenAcademyCourse.Write() method
type pWrite struct {
	*models.Method
}

// Extend adds the given fnct function as a new layer on this method.
func (m pWrite) Extend(fnct func(m.OpenAcademyCourseSet, m.OpenAcademyCourseData) bool) pWrite {
	return pWrite{
		Method: m.Method.Extend(fnct),
	}
}
...
type OpenAcademyCourseData struct {
	*models.ModelData
}
...
func (d OpenAcademyCourseData) Set(field models.FieldName, value interface{}) m.OpenAcademyCourseData {
	return &OpenAcademyCourseData{
...
func (d OpenAcademyCourseData) Unset(field models.FieldName) m.OpenAcademyCourseData {
	return &OpenAcademyCourseData{
...
func (d OpenAcademyCourseData) Copy() m.OpenAcademyCourseData {
	return &OpenAcademyCourseData{
		d.ModelData.Copy(),
	}
}
...
func (d OpenAcademyCourseData) MergeWith(other m.OpenAcademyCourseData) {
...
func (d OpenAcademyCourseData) CreateDate() dates.DateTime {
...
func (d OpenAcademyCourseData) HasCreateDate() bool {
...
func (d OpenAcademyCourseData) SetCreateDate(value dates.DateTime) m.OpenAcademyCourseData {
...
// It returns this OpenAcademyCourseData so that calls can be chained.
func (d OpenAcademyCourseData) UnsetCreateDate() m.OpenAcademyCourseData {
...
// the Go zero value for the type is returned.
func (d OpenAcademyCourseData) CreateUID() int64 {
...
func (d OpenAcademyCourseData) HasCreateUID() bool {
...
// It returns this OpenAcademyCourseData so that calls can be chained.
func (d OpenAcademyCourseData) SetCreateUID(value int64) m.OpenAcademyCourseData {
...
// It returns this OpenAcademyCourseData so that calls can be chained.
func (d OpenAcademyCourseData) UnsetCreateUID() m.OpenAcademyCourseData {
...
// the Go zero value for the type is returned.
func (d OpenAcademyCourseData) Description() string {
...
func (d OpenAcademyCourseData) HasDescription() bool {
...
// It returns this OpenAcademyCourseData so that calls can be chained.
func (d OpenAcademyCourseData) SetDescription(value string) m.OpenAcademyCourseData {
...
// It returns this OpenAcademyCourseData so that calls can be chained.
func (d OpenAcademyCourseData) UnsetDescription() m.OpenAcademyCourseData {
...
// the Go zero value for the type is returned.
func (d OpenAcademyCourseData) DisplayName() string {
...
func (d OpenAcademyCourseData) HasDisplayName() bool {
...
// It returns this OpenAcademyCourseData so that calls can be chained.
func (d OpenAcademyCourseData) SetDisplayName(value string) m.OpenAcademyCourseData {
...
// It returns this OpenAcademyCourseData so that calls can be chained.
func (d OpenAcademyCourseData) UnsetDisplayName() m.OpenAcademyCourseData {
...
// the Go zero value for the type is returned.
func (d OpenAcademyCourseData) HexyaExternalID() string {
...
func (d OpenAcademyCourseData) HasHexyaExternalID() bool {
...
// It returns this OpenAcademyCourseData so that calls can be chained.
func (d OpenAcademyCourseData) SetHexyaExternalID(value string) m.OpenAcademyCourseData {
...
// It returns this OpenAcademyCourseData so that calls can be chained.
func (d OpenAcademyCourseData) UnsetHexyaExternalID() m.OpenAcademyCourseData {
...
// the Go zero value for the type is returned.
func (d OpenAcademyCourseData) HexyaVersion() int {
...
func (d OpenAcademyCourseData) HasHexyaVersion() bool {
...
// It returns this OpenAcademyCourseData so that calls can be chained.
func (d OpenAcademyCourseData) SetHexyaVersion(value int) m.OpenAcademyCourseData {
...
// It returns this OpenAcademyCourseData so that calls can be chained.
func (d OpenAcademyCourseData) UnsetHexyaVersion() m.OpenAcademyCourseData {
...
// the Go zero value for the type is returned.
func (d OpenAcademyCourseData) ID() int64 {
...
func (d OpenAcademyCourseData) HasID() bool {
	return d.ModelData.Has(models.NewFieldName("ID", "id"))
}

// SetID sets the ID field with the given value.
// It returns this OpenAcademyCourseData so that calls can be chained.
func (d OpenAcademyCourseData) SetID(value int64) m.OpenAcademyCourseData {
...
// It returns this OpenAcademyCourseData so that calls can be chained.
func (d OpenAcademyCourseData) UnsetID() m.OpenAcademyCourseData {
...
// the Go zero value for the type is returned.
func (d OpenAcademyCourseData) LastUpdate() dates.DateTime {
...
func (d OpenAcademyCourseData) HasLastUpdate() bool {
...
// It returns this OpenAcademyCourseData so that calls can be chained.
func (d OpenAcademyCourseData) SetLastUpdate(value dates.DateTime) m.OpenAcademyCourseData {
...
// It returns this OpenAcademyCourseData so that calls can be chained.
func (d OpenAcademyCourseData) UnsetLastUpdate() m.OpenAcademyCourseData {
...
// the Go zero value for the type is returned.
func (d OpenAcademyCourseData) Name() string {
...
func (d OpenAcademyCourseData) HasName() bool {
	return d.ModelData.Has(models.NewFieldName("Name", "name"))
}

// SetName sets the Name field with the given value.
// It returns this OpenAcademyCourseData so that calls can be chained.
func (d OpenAcademyCourseData) SetName(value string) m.OpenAcademyCourseData {
...
// It returns this OpenAcademyCourseData so that calls can be chained.
func (d OpenAcademyCourseData) UnsetName() m.OpenAcademyCourseData {
...
// the Go zero value for the type is returned.
func (d OpenAcademyCourseData) Responsible() m.UserSet {
	val := d.ModelData.Get(models.NewFieldName("Responsible", "responsible_id"))
	if !d.Has(models.NewFieldName("Responsible", "responsible_id")) || val == nil || val == (*interface{})(nil) {
...
func (d OpenAcademyCourseData) HasResponsible() bool {
	return d.ModelData.Has(models.NewFieldName("Responsible", "responsible_id"))
}

// SetResponsible sets the Responsible field with the given value.
// It returns this OpenAcademyCourseData so that calls can be chained.
func (d OpenAcademyCourseData) SetResponsible(value m.UserSet) m.OpenAcademyCourseData {
	d.ModelData.Set(models.NewFieldName("Responsible", "responsible_id"), value)
	return d
}

// UnsetResponsible removes the value of the Responsible field if it exists.
// It returns this OpenAcademyCourseData so that calls can be chained.
func (d OpenAcademyCourseData) UnsetResponsible() m.OpenAcademyCourseData {
	d.ModelData.Unset(models.NewFieldName("Responsible", "responsible_id"))
	return d
}
...
func (d OpenAcademyCourseData) CreateResponsible(related m.UserData) m.OpenAcademyCourseData {
	d.ModelData.Create(models.NewFieldName("Responsible", "responsible_id"), related.Underlying())
	return d
}
...
// the Go zero value for the type is returned.
func (d OpenAcademyCourseData) Sessions() m.OpenAcademySessionSet {
	val := d.ModelData.Get(models.NewFieldName("Sessions", "sessions_ids"))
	if !d.Has(models.NewFieldName("Sessions", "sessions_ids")) || val == nil || val == (*interface{})(nil) {
		val = models.InvalidRecordCollection("OpenAcademySession")
	}
	return val.(models.RecordSet).Collection().Wrap().(m.OpenAcademySessionSet)
}

// HasSessions returns true if Sessions is set in this OpenAcademyCourseData
func (d OpenAcademyCourseData) HasSessions() bool {
	return d.ModelData.Has(models.NewFieldName("Sessions", "sessions_ids"))
}

// SetSessions sets the Sessions field with the given value.
// It returns this OpenAcademyCourseData so that calls can be chained.
func (d OpenAcademyCourseData) SetSessions(value m.OpenAcademySessionSet) m.OpenAcademyCourseData {
	d.ModelData.Set(models.NewFieldName("Sessions", "sessions_ids"), value)
	return d
}

// UnsetSessions removes the value of the Sessions field if it exists.
// It returns this OpenAcademyCourseData so that calls can be chained.
func (d OpenAcademyCourseData) UnsetSessions() m.OpenAcademyCourseData {
	d.ModelData.Unset(models.NewFieldName("Sessions", "sessions_ids"))
	return d
}
...
//
// This method can be called multiple times to create multiple records
func (d OpenAcademyCourseData) CreateSessions(related m.OpenAcademySessionData) m.OpenAcademyCourseData {
	d.ModelData.Create(models.NewFieldName("Sessions", "sessions_ids"), related.Underlying())
	return d
}
...
// the Go zero value for the type is returned.
func (d OpenAcademyCourseData) State() string {
...
func (d OpenAcademyCourseData) HasState() bool {
	return d.ModelData.Has(models.NewFieldName("State", "state"))
}

// SetState sets the State field with the given value.
// It returns this OpenAcademyCourseData so that calls can be chained.
func (d OpenAcademyCourseData) SetState(value string) m.OpenAcademyCourseData {
...
// It returns this OpenAcademyCourseData so that calls can be chained.
func (d OpenAcademyCourseData) UnsetState() m.OpenAcademyCourseData {
...
// the Go zero value for the type is returned.
func (d OpenAcademyCourseData) WriteDate() dates.DateTime {
...
func (d OpenAcademyCourseData) HasWriteDate() bool {
...
// It returns this OpenAcademyCourseData so that calls can be chained.
func (d OpenAcademyCourseData) SetWriteDate(value dates.DateTime) m.OpenAcademyCourseData {
...
// It returns this OpenAcademyCourseData so that calls can be chained.
func (d OpenAcademyCourseData) UnsetWriteDate() m.OpenAcademyCourseData {
...
// the Go zero value for the type is returned.
func (d OpenAcademyCourseData) WriteUID() int64 {
...
func (d OpenAcademyCourseData) HasWriteUID() bool {
	return d.ModelData.Has(models.NewFieldName("WriteUID", "write_uid"))
}

// SetWriteUID sets the WriteUID field with the given value.
// It returns this OpenAcademyCourseData so that calls can be chained.
func (d OpenAcademyCourseData) SetWriteUID(value int64) m.OpenAcademyCourseData {
...
// It returns this OpenAcademyCourseData so that calls can be chained.
func (d OpenAcademyCourseData) UnsetWriteUID() m.OpenAcademyCourseData {
	d.ModelData.Unset(models.NewFieldName("WriteUID", "write_uid"))
	return d
}

var _ m.OpenAcademyCourseData = new(OpenAcademyCourseData)
var _ m.OpenAcademyCourseData = OpenAcademyCourseData{}
...
type OpenAcademyCourseGroupAggregateRow struct {
	values    m.OpenAcademyCourseData
	count     int
	condition q.OpenAcademyCourseCondition
}

// Values returns the values of the actual query
func (a OpenAcademyCourseGroupAggregateRow) Values() m.OpenAcademyCourseData {
	return a.values
}

// Count returns the number of lines aggregated into this one
func (a OpenAcademyCourseGroupAggregateRow) Count() int {
	return a.count
}

// Condition can be used to query the aggregated rows separately if needed
func (a OpenAcademyCourseGroupAggregateRow) Condition() q.OpenAcademyCourseCondition {
	return a.condition
}
...
type OpenAcademyCourseSet struct {
	*models.RecordCollection
}

var _ models.RecordSet = OpenAcademyCourseSet{}

// OpenAcademyCourseSetHexyaFunc is a dummy function to uniquely match interfaces.
func (s OpenAcademyCourseSet) OpenAcademyCourseSetHexyaFunc() {}

// IsValid returns true if this RecordSet has been initialized.
func (s OpenAcademyCourseSet) IsValid() bool {
...
func (s OpenAcademyCourseSet) ForceLoad(fields ...models.FieldName) m.OpenAcademyCourseSet {
...
// RecordSets
func (s OpenAcademyCourseSet) Records() []m.OpenAcademyCourseSet {
	recs := s.RecordCollection.Records()
	res := make([]m.OpenAcademyCourseSet, len(recs))
	for i, rec := range recs {
		res[i] = rec.Wrap("OpenAcademyCourse").(m.OpenAcademyCourseSet)
	}
	return res
}

// CartesianProduct returns the cartesian product of this OpenAcademyCourseSet with others.
func (s OpenAcademyCourseSet) CartesianProduct(others ...m.OpenAcademyCourseSet) []m.OpenAcademyCourseSet {
...
func (s OpenAcademyCourseSet) First() m.OpenAcademyCourseData {
	return &OpenAcademyCourseData{
...
func (s OpenAcademyCourseSet) All() []m.OpenAcademyCourseData {
	allSlice := s.RecordCollection.All()
	res := make([]m.OpenAcademyCourseData, len(allSlice))
	for i, v := range allSlice {
		res[i] = &OpenAcademyCourseData{v}
	}
	return res
}

// Sorted returns a new OpenAcademyCourseSet sorted according to the given less function.
//
// The less function should return true if rs1 < rs2
func (s OpenAcademyCourseSet) Sorted(less func(rs1, rs2 m.OpenAcademyCourseSet) bool) m.OpenAcademyCourseSet {
	res := s.RecordCollection.Sorted(func(rc1 models.RecordSet, rc2 models.RecordSet) bool {
		return less(OpenAcademyCourseSet{RecordCollection: rc1.Collection()}, OpenAcademyCourseSet{RecordCollection: rc2.Collection()})
	})
	return res.Wrap("OpenAcademyCourse").(m.OpenAcademyCourseSet)
}

// Filtered returns a new OpenAcademyCourseSet with only the elements of this record set
// for which test is true.
//
// Note that if this OpenAcademyCourseSet is not fully loaded, this function will call the database
...
func (s OpenAcademyCourseSet) Filtered(test func(rs m.OpenAcademyCourseSet) bool) m.OpenAcademyCourseSet {
	res := s.RecordCollection.Filtered(func(rc models.RecordSet) bool {
		return test(OpenAcademyCourseSet{RecordCollection: rc.Collection()})
	})
	return res.Wrap("OpenAcademyCourse").(m.OpenAcademyCourseSet)
}
...
func (s OpenAcademyCourseSet) CreateDate() dates.DateTime {
...
func (s OpenAcademyCourseSet) SetCreateDate(value dates.DateTime) {
...
// record in this RecordSet. It returns the Go zero value if the RecordSet is empty.
func (s OpenAcademyCourseSet) CreateUID() int64 {
...
func (s OpenAcademyCourseSet) SetCreateUID(value int64) {
...
// record in this RecordSet. It returns the Go zero value if the RecordSet is empty.
func (s OpenAcademyCourseSet) Description() string {
...
func (s OpenAcademyCourseSet) SetDescription(value string) {
...
// record in this RecordSet. It returns the Go zero value if the RecordSet is empty.
func (s OpenAcademyCourseSet) DisplayName() string {
...
func (s OpenAcademyCourseSet) SetDisplayName(value string) {
...
// record in this RecordSet. It returns the Go zero value if the RecordSet is empty.
func (s OpenAcademyCourseSet) HexyaExternalID() string {
...
func (s OpenAcademyCourseSet) SetHexyaExternalID(value string) {
...
// record in this RecordSet. It returns the Go zero value if the RecordSet is empty.
func (s OpenAcademyCourseSet) HexyaVersion() int {
...
func (s OpenAcademyCourseSet) SetHexyaVersion(value int) {
...
// record in this RecordSet. It returns the Go zero value if the RecordSet is empty.
func (s OpenAcademyCourseSet) ID() int64 {
...
func (s OpenAcademyCourseSet) SetID(value int64) {
...
// record in this RecordSet. It returns the Go zero value if the RecordSet is empty.
func (s OpenAcademyCourseSet) LastUpdate() dates.DateTime {
...
func (s OpenAcademyCourseSet) SetLastUpdate(value dates.DateTime) {
...
// record in this RecordSet. It returns the Go zero value if the RecordSet is empty.
func (s OpenAcademyCourseSet) Name() string {
...
func (s OpenAcademyCourseSet) SetName(value string) {
...
// record in this RecordSet. It returns the Go zero value if the RecordSet is empty.
func (s OpenAcademyCourseSet) Responsible() m.UserSet {
	res, _ := s.RecordCollection.Get(models.NewFieldName("Responsible", "responsible_id")).(models.RecordSet).Collection().Wrap("User").(m.UserSet)
	return res
}
...
func (s OpenAcademyCourseSet) SetResponsible(value m.UserSet) {
	s.RecordCollection.Set(models.NewFieldName("Responsible", "responsible_id"), value)
}

// Sessions is a getter for the value of the "Sessions" field of the first
// record in this RecordSet. It returns the Go zero value if the RecordSet is empty.
func (s OpenAcademyCourseSet) Sessions() m.OpenAcademySessionSet {
	res, _ := s.RecordCollection.Get(models.NewFieldName("Sessions", "sessions_ids")).(models.RecordSet).Collection().Wrap("OpenAcademySession").(m.OpenAcademySessionSet)
	return res
}
...
func (s OpenAcademyCourseSet) SetSessions(value m.OpenAcademySessionSet) {
	s.RecordCollection.Set(models.NewFieldName("Sessions", "sessions_ids"), value)
}

// State is a getter for the value of the "State" field of the first
// record in this RecordSet. It returns the Go zero value if the RecordSet is empty.
func (s OpenAcademyCourseSet) State() string {
...
func (s OpenAcademyCourseSet) SetState(value string) {
...
// record in this RecordSet. It returns the Go zero value if the RecordSet is empty.
func (s OpenAcademyCourseSet) WriteDate() dates.DateTime {
...
func (s OpenAcademyCourseSet) SetWriteDate(value dates.DateTime) {
...
// record in this RecordSet. It returns the Go zero value if the RecordSet is empty.
func (s OpenAcademyCourseSet) WriteUID() int64 {
...
func (s OpenAcademyCourseSet) SetWriteUID(value int64) {
...
func (s OpenAcademyCourseSet) Super() m.OpenAcademyCourseSet {
	return s.RecordCollection.Super().Wrap("OpenAcademyCourse").(m.OpenAcademyCourseSet)
}

// ModelData returns a new OpenAcademyCourseData object populated with the values
// of the given FieldMap.
func (s OpenAcademyCourseSet) ModelData(fMap models.FieldMap) m.OpenAcademyCourseData {
	res := &OpenAcademyCourseData{
		models.NewModelData(models.Registry.MustGet("OpenAcademyCourse")),
	}
	for k, v := range fMap {
		res.Set(models.Registry.MustGet("OpenAcademyCourse").FieldName(k), v)
	}
	return res
}
...
func (s OpenAcademyCourseSet) AddDomainLimitOffset(domain domains.Domain, limit int, offset int, order string) m.OpenAcademyCourseSet {
	res := s.Collection().Call("AddDomainLimitOffset", domain, limit, offset, order)
	resTyped := res.(models.RecordSet).Collection().Wrap("OpenAcademyCourse").(m.OpenAcademyCourseSet)
	return resTyped
}

// AddModifiers adds the modifiers attribute nodes to given xml doc.
func (s OpenAcademyCourseSet) AddModifiers(doc *etree.Document, fieldInfos map[string]*models.FieldInfo) {
...
func (s OpenAcademyCourseSet) AddNamesToRelations(data models.RecordData, fInfos map[string]*models.FieldInfo) models.RecordData {
...
func (s OpenAcademyCourseSet) Aggregates(fieldNames ...models.FieldName) []m.OpenAcademyCourseGroupAggregateRow {
	res := s.Collection().Call("Aggregates", fieldNames)
	resTyped, _ := res.([]m.OpenAcademyCourseGroupAggregateRow)
	return resTyped
}

// Browse returns a new RecordSet with only the records with the given ids.
// Note that this function is just a shorcut for Search on a list of ids.
func (s OpenAcademyCourseSet) Browse(ids []int64) m.OpenAcademyCourseSet {
...
func (s OpenAcademyCourseSet) BrowseOne(id int64) m.OpenAcademyCourseSet {
...
func (s OpenAcademyCourseSet) CheckAccessRights(args webtypes.CheckAccessRightsArgs) bool {
...
func (s OpenAcademyCourseSet) CheckExecutionPermission(method *models.Method, dontPanic ...bool) bool {
...
func (s OpenAcademyCourseSet) CheckRecursion() bool {
...
func (s OpenAcademyCourseSet) ComputeDisplayName() *models.ModelData {
...
func (s OpenAcademyCourseSet) ComputeLastUpdate() *models.ModelData {
	res := s.Collection().Call("ComputeLastUpdate")
	resTyped, _ := res.(*models.ModelData)
	return resTyped
}

// Copy duplicates the given OpenAcademyCourse record, overridding values with overrides.
func (s OpenAcademyCourseSet) Copy(overrides m.OpenAcademyCourseData) m.OpenAcademyCourseSet {
...
func (s OpenAcademyCourseSet) CopyData(overrides m.OpenAcademyCourseData) m.OpenAcademyCourseData {
	res := s.Collection().Call("CopyData", overrides)
	resTyped, _ := res.(models.RecordData)
	return resTyped.Underlying().Wrap().(m.OpenAcademyCourseData)
}

// Create inserts a OpenAcademyCourse record in the database from the given data.
// Returns the created OpenAcademyCourseSet.
func (s OpenAcademyCourseSet) Create(data m.OpenAcademyCourseData) m.OpenAcademyCourseSet {
	res := s.Collection().Call("Create", data)
	resTyped := res.(models.RecordSet).Collection().Wrap("OpenAcademyCourse").(m.OpenAcademyCourseSet)
	return resTyped
}

// DefaultGet returns a OpenAcademyCourseData with the default values for the model.
func (s OpenAcademyCourseSet) DefaultGet() m.OpenAcademyCourseData {
...
func (s OpenAcademyCourseSet) Enqueue(description string, method models.Methoder, arguments ...interface{}) m.QueueJobSet {
...
func (s OpenAcademyCourseSet) Equals(other m.OpenAcademyCourseSet) bool {
...
func (s OpenAcademyCourseSet) ExecuteO2MActions(fieldName models.FieldName, info *models.FieldInfo, value interface{}) interface{} {
...
func (s OpenAcademyCourseSet) Fetch() m.OpenAcademyCourseSet {
...
func (s OpenAcademyCourseSet) FieldGet(field models.FieldName) *models.FieldInfo {
...
func (s OpenAcademyCourseSet) FieldsGet(args models.FieldsGetArgs) map[string]*models.FieldInfo {
...
// view architecture.
func (s OpenAcademyCourseSet) FieldsViewGet(args webtypes.FieldsViewGetParams) *webtypes.FieldsViewData {
...
func (s OpenAcademyCourseSet) FormatRelationFields(data models.RecordData, fInfos map[string]*models.FieldInfo) models.RecordData {
...
func (s OpenAcademyCourseSet) GetFormviewAction() *actions.Action {
...
// This method is meant to be overridden in addons that want
// to give specific view ids for example.
func (s OpenAcademyCourseSet) GetFormviewId() string {
...
func (s OpenAcademyCourseSet) GetRecord(externalID string) m.OpenAcademyCourseSet {
...
func (s OpenAcademyCourseSet) GetToolbar() webtypes.Toolbar {
...
func (s OpenAcademyCourseSet) GroupBy(exprs ...models.FieldName) m.OpenAcademyCourseSet {
...
func (s OpenAcademyCourseSet) Intersect(other m.OpenAcademyCourseSet) m.OpenAcademyCourseSet {
...
func (s OpenAcademyCourseSet) Limit(limit int) m.OpenAcademyCourseSet {
...
// model are retrieved.
func (s OpenAcademyCourseSet) Load(fields ...models.FieldName) m.OpenAcademyCourseSet {
...
func (s OpenAcademyCourseSet) LoadViews(args webtypes.LoadViewsArgs) *webtypes.LoadViewsData {
...
func (s OpenAcademyCourseSet) ManageGroupsOnFields(doc *etree.Document, fieldInfos map[string]*models.FieldInfo) {
	s.Collection().Call("ManageGroupsOnFields", doc, fieldInfos)
}

// NameGet retrieves the human readable name of this record.`,
func (s OpenAcademyCourseSet) NameGet() string {
...
func (s OpenAcademyCourseSet) NameSearch(params webtypes.NameSearchParams) []webtypes.RecordIDWithName {
	res := s.Collection().Call("NameSearch", params)
	resTyped, _ := res.([]webtypes.RecordIDWithName)
	return resTyped
}

// New creates a OpenAcademyCourse record in memory from the given data.
// Such OpenAcademyCourseSet has a negative ID and cannot be reloaded from the database
func (s OpenAcademyCourseSet) New(data m.OpenAcademyCourseData) m.OpenAcademyCourseSet {
...
func (s OpenAcademyCourseSet) NormalizeM2MData(fieldName models.FieldName, info *models.FieldInfo, value interface{}) interface{} {
...
func (s OpenAcademyCourseSet) Offset(offset int) m.OpenAcademyCourseSet {
...
func (s OpenAcademyCourseSet) Onchange(params models.OnchangeParams) models.OnchangeResult {
...
func (s OpenAcademyCourseSet) OrderBy(exprs ...string) m.OpenAcademyCourseSet {
...
func (s OpenAcademyCourseSet) PostProcessCreateValues(data models.RecordData) {
...
func (s OpenAcademyCourseSet) PostProcessFilters(in map[models.FieldName]models.Conditioner) map[string][]interface{} {
...
func (s OpenAcademyCourseSet) ProcessCreateValues(data models.RecordData) (models.RecordData, models.RecordData) {
...
func (s OpenAcademyCourseSet) ProcessElementAttrs(element *etree.Element, fieldInfos map[string]*models.FieldInfo) map[string]interface{} {
...
func (s OpenAcademyCourseSet) ProcessFieldElementModifiers(element *etree.Element, fieldInfos map[string]*models.FieldInfo, modifiers map[string]interface{}) map[string]interface{} {
...
func (s OpenAcademyCourseSet) ProcessView(arch *etree.Document, fieldInfos map[string]*models.FieldInfo) string {
...
// compatible with the ORM, in particular for relation fields
func (s OpenAcademyCourseSet) ProcessWriteValues(data models.RecordData) models.RecordData {
...
func (s OpenAcademyCourseSet) Read(fields models.FieldNames) []models.RecordData {
...
func (s OpenAcademyCourseSet) ReadGroup(params webtypes.ReadGroupParams) []models.FieldMap {
...
// the given condition.`,
func (s OpenAcademyCourseSet) SQLFromCondition(c *models.Condition) (string, models.SQLParams) {
...
// Search returns a new OpenAcademyCourseSet filtering on the current one with the additional given Condition
func (s OpenAcademyCourseSet) Search(condition q.OpenAcademyCourseCondition) m.OpenAcademyCourseSet {
...
func (s OpenAcademyCourseSet) SearchAll() m.OpenAcademyCourseSet {
	res := s.Collection().Call("SearchAll")
	resTyped := res.(models.RecordSet).Collection().Wrap("OpenAcademyCourse").(m.OpenAcademyCourseSet)
	return resTyped
}

// SearchByName searches for OpenAcademyCourse records that have a display name matching the given
...
// value for a relational field. Sometimes be seen as the inverse
// function of NameGet but it is not guaranteed to be.
func (s OpenAcademyCourseSet) SearchByName(name string, op operator.Operator, additionalCond q.OpenAcademyCourseCondition, limit int) m.OpenAcademyCourseSet {
...
func (s OpenAcademyCourseSet) SearchCount() int {
...
func (s OpenAcademyCourseSet) SearchDomain(domain domains.Domain) m.CommonMixinSet {
...
func (s OpenAcademyCourseSet) SearchRead(params webtypes.SearchParams) []models.RecordData {
...
func (s OpenAcademyCourseSet) SortedByField(namer models.FieldName, reverse bool) m.OpenAcademyCourseSet {
...
func (s OpenAcademyCourseSet) SortedDefault() m.OpenAcademyCourseSet {
...
func (s OpenAcademyCourseSet) Subtract(other m.OpenAcademyCourseSet) m.OpenAcademyCourseSet {
...
func (s OpenAcademyCourseSet) Sudo(userID ...int64) m.OpenAcademyCourseSet {
...
func (s OpenAcademyCourseSet) ToggleActive() {
...
func (s OpenAcademyCourseSet) Union(other m.OpenAcademyCourseSet) m.OpenAcademyCourseSet {
...
func (s OpenAcademyCourseSet) Unlink() int64 {
...
func (s OpenAcademyCourseSet) WebReadGroup(params webtypes.WebReadGroupParams) webtypes.WebReadGroupResult {
...
func (s OpenAcademyCourseSet) WebReadGroupPrivate(params webtypes.WebReadGroupParams) []models.FieldMap {
...
func (s OpenAcademyCourseSet) WebSearchRead(params webtypes.SearchParams) webtypes.SearchReadResult {
...
func (s OpenAcademyCourseSet) WithContext(key string, value interface{}) m.OpenAcademyCourseSet {
...
func (s OpenAcademyCourseSet) WithEnv(env models.Environment) m.OpenAcademyCourseSet {
...
func (s OpenAcademyCourseSet) WithNewContext(context *types.Context) m.OpenAcademyCourseSet {
...
// OpenAcademyCourse records in the database with the given data.
func (s OpenAcademyCourseSet) Write(data m.OpenAcademyCourseData) bool {
...
// Aggregates returns the result of this RecordSet query, which must by a grouped query.
func m_OpenAcademyCourse_Aggregates(rs OpenAcademyCourseSet, fieldNames ...models.FieldName) []m.OpenAcademyCourseGroupAggregateRow {
	lines := rs.RecordCollection.Aggregates(fieldNames...)
	res := make([]m.OpenAcademyCourseGroupAggregateRow, len(lines))
	for i, l := range lines {
		res[i] = OpenAcademyCourseGroupAggregateRow{
			values: l.Values.Wrap().(m.OpenAcademyCourseData),
			count:  l.Count,
			condition: q.OpenAcademyCourseCondition{
...
func init() {
	models.CreateModel("OpenAcademyCourse", 0)
	models.Registry.MustGet("OpenAcademyCourse").AddFields(map[string]models.FieldDefinition{
	...
	models.Registry.MustGet("OpenAcademyCourse").AddEmptyMethod("ActionArchive")
	models.Registry.MustGet("OpenAcademyCourse").AddEmptyMethod("ActionUnarchive")
	models.Registry.MustGet("OpenAcademyCourse").AddEmptyMethod("AddDomainLimitOffset")
	models.Registry.MustGet("OpenAcademyCourse").AddEmptyMethod("AddModifiers")
	models.Registry.MustGet("OpenAcademyCourse").AddEmptyMethod("AddNamesToRelations")
	models.Registry.MustGet("OpenAcademyCourse").AddEmptyMethod("Browse")
	models.Registry.MustGet("OpenAcademyCourse").AddEmptyMethod("BrowseOne")
	models.Registry.MustGet("OpenAcademyCourse").AddEmptyMethod("CheckAccessRights")
	models.Registry.MustGet("OpenAcademyCourse").AddEmptyMethod("CheckExecutionPermission")
	models.Registry.MustGet("OpenAcademyCourse").AddEmptyMethod("CheckRecursion")
	models.Registry.MustGet("OpenAcademyCourse").AddEmptyMethod("ComputeDisplayName")
	models.Registry.MustGet("OpenAcademyCourse").AddEmptyMethod("ComputeLastUpdate")
	models.Registry.MustGet("OpenAcademyCourse").AddEmptyMethod("Copy")
	models.Registry.MustGet("OpenAcademyCourse").AddEmptyMethod("CopyData")
	models.Registry.MustGet("OpenAcademyCourse").AddEmptyMethod("Create")
	models.Registry.MustGet("OpenAcademyCourse").AddEmptyMethod("DefaultGet")
	models.Registry.MustGet("OpenAcademyCourse").AddEmptyMethod("Enqueue")
	models.Registry.MustGet("OpenAcademyCourse").AddEmptyMethod("Equals")
	models.Registry.MustGet("OpenAcademyCourse").AddEmptyMethod("ExecuteO2MActions")
	models.Registry.MustGet("OpenAcademyCourse").AddEmptyMethod("Fetch")
	models.Registry.MustGet("OpenAcademyCourse").AddEmptyMethod("FieldGet")
	models.Registry.MustGet("OpenAcademyCourse").AddEmptyMethod("FieldsGet")
	models.Registry.MustGet("OpenAcademyCourse").AddEmptyMethod("FieldsViewGet")
	models.Registry.MustGet("OpenAcademyCourse").AddEmptyMethod("FormatRelationFields")
	models.Registry.MustGet("OpenAcademyCourse").AddEmptyMethod("GetFormviewAction")
	models.Registry.MustGet("OpenAcademyCourse").AddEmptyMethod("GetFormviewId")
	models.Registry.MustGet("OpenAcademyCourse").AddEmptyMethod("GetRecord")
	models.Registry.MustGet("OpenAcademyCourse").AddEmptyMethod("GetToolbar")
	models.Registry.MustGet("OpenAcademyCourse").AddEmptyMethod("GroupBy")
	models.Registry.MustGet("OpenAcademyCourse").AddEmptyMethod("Intersect")
	models.Registry.MustGet("OpenAcademyCourse").AddEmptyMethod("Limit")
	models.Registry.MustGet("OpenAcademyCourse").AddEmptyMethod("Load")
	models.Registry.MustGet("OpenAcademyCourse").AddEmptyMethod("LoadViews")
	models.Registry.MustGet("OpenAcademyCourse").AddEmptyMethod("ManageGroupsOnFields")
	models.Registry.MustGet("OpenAcademyCourse").AddEmptyMethod("NameGet")
	models.Registry.MustGet("OpenAcademyCourse").AddEmptyMethod("NameSearch")
	models.Registry.MustGet("OpenAcademyCourse").AddEmptyMethod("New")
	models.Registry.MustGet("OpenAcademyCourse").AddEmptyMethod("NormalizeM2MData")
	models.Registry.MustGet("OpenAcademyCourse").AddEmptyMethod("Offset")
	models.Registry.MustGet("OpenAcademyCourse").AddEmptyMethod("Onchange")
	models.Registry.MustGet("OpenAcademyCourse").AddEmptyMethod("OrderBy")
	models.Registry.MustGet("OpenAcademyCourse").AddEmptyMethod("PostProcessCreateValues")
	models.Registry.MustGet("OpenAcademyCourse").AddEmptyMethod("PostProcessFilters")
	models.Registry.MustGet("OpenAcademyCourse").AddEmptyMethod("ProcessCreateValues")
	models.Registry.MustGet("OpenAcademyCourse").AddEmptyMethod("ProcessElementAttrs")
	models.Registry.MustGet("OpenAcademyCourse").AddEmptyMethod("ProcessFieldElementModifiers")
	models.Registry.MustGet("OpenAcademyCourse").AddEmptyMethod("ProcessView")
	models.Registry.MustGet("OpenAcademyCourse").AddEmptyMethod("ProcessWriteValues")
	models.Registry.MustGet("OpenAcademyCourse").AddEmptyMethod("Read")
	models.Registry.MustGet("OpenAcademyCourse").AddEmptyMethod("ReadGroup")
	models.Registry.MustGet("OpenAcademyCourse").AddEmptyMethod("SQLFromCondition")
	models.Registry.MustGet("OpenAcademyCourse").AddEmptyMethod("Search")
	models.Registry.MustGet("OpenAcademyCourse").AddEmptyMethod("SearchAll")
	models.Registry.MustGet("OpenAcademyCourse").AddEmptyMethod("SearchByName")
	models.Registry.MustGet("OpenAcademyCourse").AddEmptyMethod("SearchCount")
	models.Registry.MustGet("OpenAcademyCourse").AddEmptyMethod("SearchDomain")
	models.Registry.MustGet("OpenAcademyCourse").AddEmptyMethod("SearchRead")
	models.Registry.MustGet("OpenAcademyCourse").AddEmptyMethod("SortedByField")
	models.Registry.MustGet("OpenAcademyCourse").AddEmptyMethod("SortedDefault")
	models.Registry.MustGet("OpenAcademyCourse").AddEmptyMethod("Subtract")
	models.Registry.MustGet("OpenAcademyCourse").AddEmptyMethod("Sudo")
	models.Registry.MustGet("OpenAcademyCourse").AddEmptyMethod("ToggleActive")
	models.Registry.MustGet("OpenAcademyCourse").AddEmptyMethod("Union")
	models.Registry.MustGet("OpenAcademyCourse").AddEmptyMethod("Unlink")
	models.Registry.MustGet("OpenAcademyCourse").AddEmptyMethod("WebReadGroup")
	models.Registry.MustGet("OpenAcademyCourse").AddEmptyMethod("WebReadGroupPrivate")
	models.Registry.MustGet("OpenAcademyCourse").AddEmptyMethod("WebSearchRead")
	models.Registry.MustGet("OpenAcademyCourse").AddEmptyMethod("WithContext")
	models.Registry.MustGet("OpenAcademyCourse").AddEmptyMethod("WithEnv")
	models.Registry.MustGet("OpenAcademyCourse").AddEmptyMethod("WithNewContext")
	models.Registry.MustGet("OpenAcademyCourse").AddEmptyMethod("Write")
	models.Registry.MustGet("OpenAcademyCourse").NewMethod("Aggregates", m_OpenAcademyCourse_Aggregates)
	models.RegisterRecordSetWrapper("OpenAcademyCourse", OpenAcademyCourseSet{})
	models.RegisterModelDataWrapper("OpenAcademyCourse", OpenAcademyCourseData{})
}
