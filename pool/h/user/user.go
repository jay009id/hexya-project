...
// AttendedSessions returns a pointer to the AttendedSessions Field.
func (c FieldsCollection) AttendedSessions() *models.Field {
	return c.MustGet("AttendedSessions")
}
...
// AttendedSessions returns the value of the AttendedSessions field.
// If this AttendedSessions is not set in this UserData, then
// the Go zero value for the type is returned.
func (d UserData) AttendedSessions() m.OpenAcademySessionSet {
	val := d.ModelData.Get(models.NewFieldName("AttendedSessions", "attended_sessions_ids"))
	if !d.Has(models.NewFieldName("AttendedSessions", "attended_sessions_ids")) || val == nil || val == (*interface{})(nil) {
		val = models.InvalidRecordCollection("OpenAcademySession")
	}
	return val.(models.RecordSet).Collection().Wrap().(m.OpenAcademySessionSet)
}

// HasAttendedSessions returns true if AttendedSessions is set in this UserData
func (d UserData) HasAttendedSessions() bool {
	return d.ModelData.Has(models.NewFieldName("AttendedSessions", "attended_sessions_ids"))
}

// SetAttendedSessions sets the AttendedSessions field with the given value.
// It returns this UserData so that calls can be chained.
func (d UserData) SetAttendedSessions(value m.OpenAcademySessionSet) m.UserData {
	d.ModelData.Set(models.NewFieldName("AttendedSessions", "attended_sessions_ids"), value)
	return d
}

// UnsetAttendedSessions removes the value of the AttendedSessions field if it exists.
// It returns this UserData so that calls can be chained.
func (d UserData) UnsetAttendedSessions() m.UserData {
	d.ModelData.Unset(models.NewFieldName("AttendedSessions", "attended_sessions_ids"))
	return d
}

// CreateAttendedSessions stores the related OpenAcademySessionData to be used to create
// a related record on the fly for AttendedSessions.
//
// This method can be called multiple times to create multiple records
func (d UserData) CreateAttendedSessions(related m.OpenAcademySessionData) m.UserData {
	d.ModelData.Create(models.NewFieldName("AttendedSessions", "attended_sessions_ids"), related.Underlying())
	return d
}
...
// If this Image1024 is not set in this UserData, then
// the Go zero value for the type is returned.
func (d UserData) Image1024() string {
...
// HasImage1024 returns true if Image1024 is set in this UserData
func (d UserData) HasImage1024() bool {
...
// It returns this UserData so that calls can be chained.
func (d UserData) SetImage1024(value string) m.UserData {
...
// It returns this UserData so that calls can be chained.
func (d UserData) UnsetImage1024() m.UserData {
	d.ModelData.Unset(models.NewFieldName("Image1024", "image_1024"))
	return d
}

// Image128 returns the value of the Image128 field.
// If this Image128 is not set in this UserData, then
// the Go zero value for the type is returned.
func (d UserData) Image128() string {
...
// HasImage128 returns true if Image128 is set in this UserData
func (d UserData) HasImage128() bool {
	return d.ModelData.Has(models.NewFieldName("Image128", "image_128"))
}

// SetImage128 sets the Image128 field with the given value.
// It returns this UserData so that calls can be chained.
func (d UserData) SetImage128(value string) m.UserData {
...
// It returns this UserData so that calls can be chained.
func (d UserData) UnsetImage128() m.UserData {
	d.ModelData.Unset(models.NewFieldName("Image128", "image_128"))
	return d
}

// Image1920 returns the value of the Image1920 field.
// If this Image1920 is not set in this UserData, then
// the Go zero value for the type is returned.
func (d UserData) Image1920() string {
...
// HasImage1920 returns true if Image1920 is set in this UserData
func (d UserData) HasImage1920() bool {
...
// It returns this UserData so that calls can be chained.
func (d UserData) SetImage1920(value string) m.UserData {
...
// It returns this UserData so that calls can be chained.
func (d UserData) UnsetImage1920() m.UserData {
	d.ModelData.Unset(models.NewFieldName("Image1920", "image_1920"))
	return d
}

// Image256 returns the value of the Image256 field.
// If this Image256 is not set in this UserData, then
// the Go zero value for the type is returned.
func (d UserData) Image256() string {
...
// HasImage256 returns true if Image256 is set in this UserData
func (d UserData) HasImage256() bool {
	return d.ModelData.Has(models.NewFieldName("Image256", "image_256"))
}

// SetImage256 sets the Image256 field with the given value.
// It returns this UserData so that calls can be chained.
func (d UserData) SetImage256(value string) m.UserData {
...
// It returns this UserData so that calls can be chained.
func (d UserData) UnsetImage256() m.UserData {
	d.ModelData.Unset(models.NewFieldName("Image256", "image_256"))
	return d
}

// Image512 returns the value of the Image512 field.
// If this Image512 is not set in this UserData, then
// the Go zero value for the type is returned.
func (d UserData) Image512() string {
...
// HasImage512 returns true if Image512 is set in this UserData
func (d UserData) HasImage512() bool {
	return d.ModelData.Has(models.NewFieldName("Image512", "image_512"))
}

// SetImage512 sets the Image512 field with the given value.
// It returns this UserData so that calls can be chained.
func (d UserData) SetImage512(value string) m.UserData {
...
// It returns this UserData so that calls can be chained.
func (d UserData) UnsetImage512() m.UserData {
...
// If this Instructor is not set in this UserData, then
// the Go zero value for the type is returned.
func (d UserData) Instructor() bool {
	val := d.ModelData.Get(models.NewFieldName("Instructor", "instructor"))
	if !d.Has(models.NewFieldName("Instructor", "instructor")) {
		return *new(bool)
	}
	return val.(bool)
}

// HasInstructor returns true if Instructor is set in this UserData
func (d UserData) HasInstructor() bool {
	return d.ModelData.Has(models.NewFieldName("Instructor", "instructor"))
}

// SetInstructor sets the Instructor field with the given value.
// It returns this UserData so that calls can be chained.
func (d UserData) SetInstructor(value bool) m.UserData {
	d.ModelData.Set(models.NewFieldName("Instructor", "instructor"), value)
	return d
}

// UnsetInstructor removes the value of the Instructor field if it exists.
// It returns this UserData so that calls can be chained.
func (d UserData) UnsetInstructor() m.UserData {
	d.ModelData.Unset(models.NewFieldName("Instructor", "instructor"))
	return d
}
...
// AttendedSessions is a getter for the value of the "AttendedSessions" field of the first
// record in this RecordSet. It returns the Go zero value if the RecordSet is empty.
func (s UserSet) AttendedSessions() m.OpenAcademySessionSet {
	res, _ := s.RecordCollection.Get(models.NewFieldName("AttendedSessions", "attended_sessions_ids")).(models.RecordSet).Collection().Wrap("OpenAcademySession").(m.OpenAcademySessionSet)
	return res
}

// SetAttendedSessions is a setter for the value of the "AttendedSessions" field of this
// RecordSet. All Records of this RecordSet will be updated. Each call to this
// method makes an update query in the database.
//
// SetAttendedSessions panics if the RecordSet is empty.
func (s UserSet) SetAttendedSessions(value m.OpenAcademySessionSet) {
	s.RecordCollection.Set(models.NewFieldName("AttendedSessions", "attended_sessions_ids"), value)
}
...
// record in this RecordSet. It returns the Go zero value if the RecordSet is empty.
func (s UserSet) Image1024() string {
...
func (s UserSet) SetImage1024(value string) {
...
// record in this RecordSet. It returns the Go zero value if the RecordSet is empty.
func (s UserSet) Image128() string {
...
func (s UserSet) SetImage128(value string) {
...
// record in this RecordSet. It returns the Go zero value if the RecordSet is empty.
func (s UserSet) Image1920() string {
...
func (s UserSet) SetImage1920(value string) {
...
// record in this RecordSet. It returns the Go zero value if the RecordSet is empty.
func (s UserSet) Image256() string {
...
func (s UserSet) SetImage256(value string) {
...
// record in this RecordSet. It returns the Go zero value if the RecordSet is empty.
func (s UserSet) Image512() string {
...
func (s UserSet) SetImage512(value string) {
...
// record in this RecordSet. It returns the Go zero value if the RecordSet is empty.
func (s UserSet) Instructor() bool {
	res, _ := s.RecordCollection.Get(models.NewFieldName("Instructor", "instructor")).(bool)
	return res
}
...
func (s UserSet) SetInstructor(value bool) {
	s.RecordCollection.Set(models.NewFieldName("Instructor", "instructor"), value)
}
...
func init() {
	...
	models.Registry.MustGet("User").AddFields(map[string]models.FieldDefinition{
		...
		"AttendedSessions":      models.DummyField{},
