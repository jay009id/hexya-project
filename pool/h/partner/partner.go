...
// If this AttendedSessions is not set in this PartnerData, then
// the Go zero value for the type is returned.
func (d PartnerData) AttendedSessions() m.OpenAcademySessionSet {
...
// HasAttendedSessions returns true if AttendedSessions is set in this PartnerData
func (d PartnerData) HasAttendedSessions() bool {
...
// It returns this PartnerData so that calls can be chained.
func (d PartnerData) SetAttendedSessions(value m.OpenAcademySessionSet) m.PartnerData {
...
// It returns this PartnerData so that calls can be chained.
func (d PartnerData) UnsetAttendedSessions() m.PartnerData {
...
func (d PartnerData) CreateAttendedSessions(related m.OpenAcademySessionData) m.PartnerData {
...
// If this Instructor is not set in this PartnerData, then
// the Go zero value for the type is returned.
func (d PartnerData) Instructor() bool {
...
// HasInstructor returns true if Instructor is set in this PartnerData
func (d PartnerData) HasInstructor() bool {
...
// It returns this PartnerData so that calls can be chained.
func (d PartnerData) SetInstructor(value bool) m.PartnerData {
...
// It returns this PartnerData so that calls can be chained.
func (d PartnerData) UnsetInstructor() m.PartnerData {
...
// record in this RecordSet. It returns the Go zero value if the RecordSet is empty.
func (s PartnerSet) AttendedSessions() m.OpenAcademySessionSet {
...
func (s PartnerSet) SetAttendedSessions(value m.OpenAcademySessionSet) {
...
// record in this RecordSet. It returns the Go zero value if the RecordSet is empty.
func (s PartnerSet) Instructor() bool {
...
func (s PartnerSet) SetInstructor(value bool) {
