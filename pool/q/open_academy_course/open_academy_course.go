...
// OpenAcademyCourseConditionHexyaFunc is a dummy function to uniquely match interfaces.
func (c Condition) OpenAcademyCourseConditionHexyaFunc() {}
...
// Description adds the "Description" field to the Condition
func (cs ConditionStart) Description() pStringConditionField {
	return pStringConditionField{
		ConditionField: cs.Field(models.NewFieldName("Description", "description")),
	}
}
...
// Responsible adds the "Responsible" field to the Condition
func (cs ConditionStart) Responsible() pMUserSetConditionField {
	return pMUserSetConditionField{
		ConditionField: cs.Field(models.NewFieldName("Responsible", "responsible_id")),
	}
}

// ResponsibleFilteredOn adds a condition with a table join on the given field and
// filters the result with the given condition
func (cs ConditionStart) ResponsibleFilteredOn(cond UserCondition) Condition {
	return Condition{
		Condition: cs.FilteredOn(models.NewFieldName("Responsible", "responsible_id"), cond.Underlying()),
	}
}

// Sessions adds the "Sessions" field to the Condition
func (cs ConditionStart) Sessions() pMOpenAcademySessionSetConditionField {
	return pMOpenAcademySessionSetConditionField{
		ConditionField: cs.Field(models.NewFieldName("Sessions", "sessions_ids")),
	}
}

// SessionsFilteredOn adds a condition with a table join on the given field and
// filters the result with the given condition
func (cs ConditionStart) SessionsFilteredOn(cond OpenAcademySessionCondition) Condition {
	return Condition{
		Condition: cs.FilteredOn(models.NewFieldName("Sessions", "sessions_ids"), cond.Underlying()),
	}
}
